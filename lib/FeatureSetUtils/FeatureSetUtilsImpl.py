...
class FeatureSetUtils:
    ...
    GIT_COMMIT_HASH = "b02cb3deb41de64d64c0a5246b56c30ad0f805b7"
    ...
    def filter_expression_matrix_with_feature_set(self, ctx, params):
        """
        :param params: instance of type
           ...
           style reference), parameter "expression_matrix_ref" of type
           "obj_ref" (An X/Y/Z style reference), parameter "output_suffix" of
        ...
        # ctx is the context object
        # return variables are: returnVal
        #BEGIN filter_expression_matrix_with_feature_set
        print('--->\nRunning FeatureSetUtils.calculate_average_expression_matrix\nparams:')
        print(json.dumps(params, indent=1))

        fs_builder = FeatureSetBuilder(self.config)
        returnVal = fs_builder.filter_matrix_with_fs(params)

        #END filter_expression_matrix_with_feature_set

        # At some point might do deeper type checking...
        if not isinstance(returnVal, dict):
            raise ValueError('Method filter_expression_matrix_with_feature_set return value ' +
                             'returnVal is not type dict as required.')
        # return the results
        return [returnVal]
