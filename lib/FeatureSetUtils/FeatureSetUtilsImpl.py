...
class FeatureSetUtils:
    ...
    GIT_COMMIT_HASH = "22a57352cdad1e9b9ffbb9a66ae521a48af7be7d"
    ...
    def upload_featureset_from_diff_expr(self, ctx, params):
        ...
        :param params: instance of type "UploadFeatureSetFromDiffExprInput"
           ...
           cutoff workspace_name: the name of the workspace it gets saved to)
           -> structure: parameter "diff_expression_ref" of type "obj_ref"
           (An X/Y/Z style reference), parameter "expression_matrix_ref" of
           type "obj_ref" (An X/Y/Z style reference), parameter "p_cutoff" of
           Double, parameter "q_cutoff" of Double, parameter
           "fold_scale_type" of String, parameter "fold_change_cutoff" of
           Double, parameter "workspace_name" of String
