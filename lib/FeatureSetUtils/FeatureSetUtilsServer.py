...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'FeatureSetUtils'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from FeatureSetUtils.FeatureSetUtilsImpl import FeatureSetUtils  # noqa @IgnorePep8
impl_FeatureSetUtils = FeatureSetUtils(config)
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_FeatureSetUtils.filter_expression_matrix_with_feature_set,
